...
#### Scenario: Reject NodeGetVolumeStats when Available metric is invalid
- **WHEN** the CO sends a NodeGetVolumeStatsRequest and the Available metric cannot be converted to int64
- **THEN** the driver returns codes.Internal error indicating which metric is invalid

#### Scenario: Reject NodeGetVolumeStats when Capacity metric is invalid
- **WHEN** the CO sends a NodeGetVolumeStatsRequest and the Capacity metric cannot be converted to int64
- **THEN** the driver returns codes.Internal error indicating which metric is invalid

#### Scenario: Reject NodeGetVolumeStats when Used metric is invalid
- **WHEN** the CO sends a NodeGetVolumeStatsRequest and the Used metric cannot be converted to int64
- **THEN** the driver returns codes.Internal error indicating which metric is invalid

#### Scenario: Reject NodeGetVolumeStats when InodesFree metric is invalid
- **WHEN** the CO sends a NodeGetVolumeStatsRequest and the InodesFree metric cannot be converted to int64
- **THEN** the driver returns codes.Internal error indicating which metric is invalid

#### Scenario: Reject NodeGetVolumeStats when Inodes metric is invalid
- **WHEN** the CO sends a NodeGetVolumeStatsRequest and the Inodes metric cannot be converted to int64
- **THEN** the driver returns codes.Internal error indicating which metric is invalid

#### Scenario: Reject NodeGetVolumeStats when InodesUsed metric is invalid
- **WHEN** the CO sends a NodeGetVolumeStatsRequest and the InodesUsed metric cannot be converted to int64
- **THEN** the driver returns codes.Internal error indicating which metric is invalid
